...
export const EditEmployee = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`https://epkgroup.in/crm/api/public/api/employee_detailslitshow/${id}`, {
          headers: {
        ...
        if (data && data.employee_details) {
          ...
          setImagePreviewUrl(`https://epkgroup.in/crm/api/storage/app/${data.employee_details.profile_img}`);
        ...
        if (data && data.employee_documents && data.employee_documents.length > 0) {
          const documents = data.employee_documents.map(doc => ({
            ...
            // selectedFile: `https://epkgroup.in/crm/api/storage/app/${doc.document_img}`,
          ...
          setFilePreviews(data.employee_documents.map(doc => `https://epkgroup.in/crm/api/storage/app/${doc.document_img}`));
  ...
  // useEffect(() => {
  //   setImagePreviewUrl(`https://epkgroup.in/crm/api/storage/app/${formData.employeePicture}`);
  ...
  const handleUpdateDocument = async (index) => {
    ...
    try {
      const response = await axios.post('https://epkgroup.in/crm/api/public/api/update_employee_document', formData, {
        headers: {
          'Authorization': `Bearer ${usertoken}`,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://epkgroup.in/crm/api/public/api/update_employee_details', {
        method: 'POST',
        body: formDataToSend,
        headers: {
          'Authorization': `Bearer ${usertoken}`
  ...
  //     try {
  //       const response = await axios.get('https://epkgroup.in/crm/api/public/api/employee_uid', {
  //         headers: {
  //           'Authorization': `Bearer ${usertoken}`
  //         }
  //       });
  ...
  useEffect(() => {
    const fetchUserRoleDropdown = async () => {
      try {
        const response = await axios.get('https://epkgroup.in/crm/api/public/api/supervisor_userrole', {
          headers: {
            'Authorization': `Bearer ${usertoken}`
          }
        });
  ...
  useEffect(() => {
    const fetchUserRoleDropdown = async () => {
      try {
        const response = await axios.get(`https://epkgroup.in/crm/api/public/api/supervisorrole_list/${formData.selectedSupervisorRoleId}`, {
          headers: {
            'Authorization': `Bearer ${usertoken}`
          }
        });
  ...
  //   const fetchUserRoleDropdown = async () => {
  //     try {
  //       const response = await axios.get(`https://epkgroup.in/crm/api/public/api/shiftslotlist`, {
  //         headers: {
  //           'Authorization': `Bearer ${usertoken}`
  //         }
  //       });
  ...
  useEffect(() => {
    const fetchUserRoleDropdown = async () => {
      try {
        const response = await axios.get(`https://epkgroup.in/crm/api/public/api/employee_document_typelist`, {
          headers: {
            'Authorization': `Bearer ${usertoken}`
          }
        });
  ...
  useEffect(() => {
    const fetchUserRoleDropdown = async () => {
      try {
        const response = await axios.get(`https://epkgroup.in/crm/api/public/api/employee_categorylist`, {
          headers: {
            'Authorization': `Bearer ${usertoken}`
          }
        });
  ...
  useEffect(() => {
    const fetchUserRoleDropdown = async () => {
      try {
        const response = await axios.get(`https://epkgroup.in/crm/api/public/api/getjobtype`, {
          headers: {
            'Authorization': `Bearer ${usertoken}`
          }
        });
