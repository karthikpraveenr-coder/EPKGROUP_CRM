...
function ProjectsList() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const response = await fetch('https://epkgroup.in/crm/api/public/api/view_teamproject_list', {
    ...
    useEffect(() => {
        const fetchMenuItems = async () => {
            try {
                const response = await axios.get(`https://epkgroup.in/crm/api/public/api/btn_menu_show/${userempid}`, {
                    headers: {
