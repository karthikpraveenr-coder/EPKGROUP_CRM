...
function ManageProjects() {
    ...
    const projecthandlesubmit = async (e) => {
        ...
        try {
            const response = await axios.post(
                'https://epkgroup.in/crm/api/public/api/add_team_project',
                formData,
                {
                    headers: {
    ...
    const Taskhandlesubmit = async (e) => {
        ...
        try {
            ...
            // Make the API call
            const response = await axios.post(
                'https://epkgroup.in/crm/api/public/api/add_team_task',
                formData,
                {
                    headers: {
                        'Authorization': `Bearer ${usertoken}`,
    ...
    useEffect(() => {
        axios.get('https://epkgroup.in/crm/api/public/api/department_drop_down', {
            headers: {
                Authorization: `Bearer ${usertoken}`
            }
        })
    ...
    useEffect(() => {
        if (selectedDepartments.length > 0) {
            ...
            axios.get(`https://epkgroup.in/crm/api/public/api/teams_drop_down/${selectedDeptIds}`, {
                headers: {
                    Authorization: `Bearer ${usertoken}`
                }
            })
    ...
    useEffect(() => {
        if (selectedTeams.length > 0) {
            ...
            axios.get(`https://epkgroup.in/crm/api/public/api/member_drop_down/${selectedTeamIds}`, {
                headers: {
                    Authorization: `Bearer ${usertoken}`
                }
            })
    ...
    useEffect(() => {
        if (taskDepartment) {
            axios.get(`https://epkgroup.in/crm/api/public/api/teams_drop_down/${taskDepartment}`, {
                headers: {
                    Authorization: `Bearer ${usertoken}`
                }
            })
    ...
    useEffect(() => {
        if (taskTeam) {
            axios.get(`https://epkgroup.in/crm/api/public/api/member_drop_down/${taskTeam}`, {
                headers: {
                    Authorization: `Bearer ${usertoken}`
                }
            })
    ...
    useEffect(() => {
        subtasks.forEach((subtask, index) => {
            if (subtask.subtaskDepartment) {
                axios.get(`https://epkgroup.in/crm/api/public/api/teams_drop_down/${subtask.subtaskDepartment}`, {
                    headers: {
                        Authorization: `Bearer ${usertoken}`
                    }
                })
    ...
    useEffect(() => {
        subtasks.forEach((subtask, index) => {
            if (subtask.subtaskTeam) {
                axios.get(`https://epkgroup.in/crm/api/public/api/member_drop_down/${subtask.subtaskTeam}`, {
                    headers: {
                        Authorization: `Bearer ${usertoken}`
                    }
                })
    ...
    useEffect(() => {
        ...
        const fetchTaskId = async () => {
            try {
                const response = await axios.get('https://epkgroup.in/crm/api/public/api/auto_task_id', {
                    headers: {
                        Authorization: `Bearer ${usertoken}`
                    }
                });
    ...
    useEffect(() => {
        ...
        const fetchProjects = async () => {
            try {
                const response = await axios.get('https://epkgroup.in/crm/api/public/api/project_drop_down', {
                    headers: {
                        Authorization: `Bearer ${usertoken}`
                    }
                });
    ...
    useEffect(() => {
        ...
        const fetchtask = async () => {
            try {
                const response = await axios.get(`https://epkgroup.in/crm/api/public/api/teamtask_drop_down/${subtaskProjectName}`, {
                    headers: {
                        Authorization: `Bearer ${usertoken}`
                    }
                });
