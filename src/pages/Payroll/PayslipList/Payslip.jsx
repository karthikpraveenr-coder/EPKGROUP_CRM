...
function Payslip() {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await fetch(`https://epkgroup.in/crm/api/public/api/get_emp_payslip_list/${id}`, {
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://epkgroup.in/crm/api/public/api/delete_payslip_list', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
