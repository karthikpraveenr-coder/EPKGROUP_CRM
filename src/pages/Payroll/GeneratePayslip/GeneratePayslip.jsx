...
const GeneratePayslip = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://epkgroup.in/crm/api/public/api/add_generate_payslip', formData, {
            headers: {
    ...
    useEffect(() => {
        if (month && selectedEmployee) {
            ...
            axios.post('https://epkgroup.in/crm/api/public/api/get_emp_yearmonth_details', {
    ...
    useEffect(() => {
        if (month && selectedEmployee && lossOfPay) {
            ...
            axios.post('https://epkgroup.in/crm/api/public/api/ot_emp_salary_details', {
                emp_id: selectedEmployee,
                yearmonth: yearMonth,
                lop: lossOfPay,
            }, {
