...
export default function EditOfferLetter() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://epkgroup.in/crm/api/public/api/update_offer_letter', formData, {
                headers: {
    ...
    useEffect(() => {
        axios.get(`https://epkgroup.in/crm/api/public/api/edit_offer_list/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
