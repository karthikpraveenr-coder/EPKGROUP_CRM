...
const AppointmentLetterView = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const offerResponse = axios.get(`https://epkgroup.in/crm/api/public/api/edit_offer_list/${id}`, {
                    headers: {
                            ...
                            <Document>
                                <Page style={styles.body}>
                                    ...
                                    <Image
                                        ...
                                        src={`https://epkgroup.in/crm/api/storage/app/${relievingletter.headerFooterData?.footer_layout}`}
                                        // src={'https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885_640.jpg'}
                                    />
                                </Page>
