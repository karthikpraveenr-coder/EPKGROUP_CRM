                ...
                <div className="a4-container-offer-letter">
                    <div className="content" ref={pdfContainerRef}>
                        ...
                        <div className="d-flex justify-content-between align-items-center mb-5 header">
                            <img src={`https://epkgroup.in/crm/api/storage/app/${relievingletter.header_layout}`} alt="Offerletter_header" className="logo" />
                        </div>
                        ...
                        <div className="d-flex justify-content-between align-items-center mb-5 footer">
                            <img src={`https://epkgroup.in/crm/api/storage/app/${relievingletter.footer_layout}`} alt="Offerletter_Footer" className="logo" />
                        </div>
