...
const AppointmentLetterView = (dummy_images) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const appointmentResponse = axios.get(`https://epkgroup.in/crm/api/public/api/edit_appointment_list/${id}`, {
                    headers: {
                        'Authorization': `Bearer ${usertoken}`
                    }
                });

                const headerFooterResponse = axios.get(`https://epkgroup.in/crm/api/public/api/edit_header_footer/${layout_id}`, {
                    headers: {
                        'Authorization': `Bearer ${usertoken}`
                    }
                });
                        ...
                        <Document>
                            <Page style={styles.body}>
                                <Image
                                    ...
                                    src={`https://epkgroup.in/crm/api/storage/app/${relievingletter.headerFooterData.header_layout ? relievingletter.headerFooterData.header_layout : ''}`}
                                />
                                ...
                                <Image
                                    ...
                                    src={`https://epkgroup.in/crm/api/storage/app/${relievingletter.headerFooterData.footer_layout ? relievingletter.headerFooterData.footer_layout : ''}`}
