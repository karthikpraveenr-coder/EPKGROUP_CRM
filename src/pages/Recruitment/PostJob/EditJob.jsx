...
const EditJob = () => {
    ...
    useEffect(() => {
        const fetchJobDetails = async () => {
            try {
                const response = await axios.get(`https://epkgroup.in/crm/api/public/api/post_job_editlist/${id}`, {
                    headers: {
    ...
    const handleSubmit = (e) => {
        ...
        axios.put('https://epkgroup.in/crm/api/public/api/update_post_job', postData, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
