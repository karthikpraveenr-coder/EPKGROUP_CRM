...
function ResumeScreening() {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await fetch('https://epkgroup.in/crm/api/public/api/career_inboxdetails', {
                method: 'GET',
                headers: {
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://epkgroup.in/crm/api/public/api/single_delete', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
    ...
    const BulkhandleDelete = async () => {
        try {
            ...
            if (reason) {
                ...
                const response = await fetch('https://epkgroup.in/crm/api/public/api/bulk_delete', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${usertoken}`
    ...
    const Markasread = async (id) => {
        try {
            const response = await axios.post(
                'https://epkgroup.in/crm/api/public/api/read_countupdate',
                {
                    id: id,
                    updated_by: userempid
                },
    ...
    const Markasunread = async (id) => {
        try {
            const response = await axios.post(
                'https://epkgroup.in/crm/api/public/api/un_read_countupdate',
                {
                    id: id,
                    updated_by: userempid
                },
    ...
    const BulkMarkasread = async () => {
        try {
            const response = await axios.post(
                'https://epkgroup.in/crm/api/public/api/bulk_read_countupdate',
                {
                    id: selectedIds.join(','),
                    updated_by: userempid
                },
    ...
    const BulkMarkasunread = async () => {
        try {
            const response = await axios.post(
                'https://epkgroup.in/crm/api/public/api/bulk_unread_countupdate',
                {
                    id: selectedIds.join(','),
                    updated_by: userempid
                },
                                            ...
                                            <tr key={row.id} style={
                                                ...
                                                <td>{row.attachment !== null ?
                                                    <Button
                                                        ...
                                                        onClick={() => {
                                                            const url = `https://epkgroup.in/crm/api/storage/app/${row.attachment}`;
