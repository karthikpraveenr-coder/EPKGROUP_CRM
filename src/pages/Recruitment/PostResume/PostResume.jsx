...
const ResumeForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://epkgroup.in/crm/api/public/api/addhr_resume_upload', formData, {
            headers: {
    ...
    useEffect(() => {
        if (functionalArea) {
            fetch(`https://epkgroup.in/crm/api/public/api/area_specialization_list/${functionalArea.value}`, {
                headers: {
                    'Authorization': `Bearer ${usertoken}`
                }
            })
    ...
    useEffect(() => {
        if (selectedCountry) {
            axios.get(`https://epkgroup.in/crm/api/public/api/state_list/${selectedCountry.value}`, {
                headers: {
                    'Authorization': `Bearer ${usertoken}`
                }
            })
    ...
    useEffect(() => {
        if (selectedState) {
            axios.get(`https://epkgroup.in/crm/api/public/api/city_list/${selectedState.value}`, {
                headers: {
                    'Authorization': `Bearer ${usertoken}`
                }
            })
