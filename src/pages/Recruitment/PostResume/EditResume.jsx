...
const EditResume = () => {
    ...
    const handleSave = (e) => {
        ...
        axios.post('https://epkgroup.in/crm/api/public/api/update_hr_resume', formData, {
            headers: {
    ...
    useEffect(() => {
        ...
        fetch('https://epkgroup.in/crm/api/public/api/ug_list', {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
    ...
    useEffect(() => {
        ...
        fetch('https://epkgroup.in/crm/api/public/api/pg_list', {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
    ...
    useEffect(() => {
        ...
        fetch('https://epkgroup.in/crm/api/public/api/industry_list', {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
    ...
    useEffect(() => {
        fetch('https://epkgroup.in/crm/api/public/api/functional_list', {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
    ...
    useEffect(() => {
        if (functionalArea) {
            fetch(`https://epkgroup.in/crm/api/public/api/area_specialization_list/${functionalArea.value || functionalArea}`, {
                headers: {
                    'Authorization': `Bearer ${usertoken}`
                }
            })
    ...
    // ------------------------------------------------------------------------------------------------------------
    useEffect(() => {
        axios.get('https://epkgroup.in/crm/api/public/api/country_list', {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
    ...
    useEffect(() => {
        if (selectedCountry) {
            axios.get(`https://epkgroup.in/crm/api/public/api/state_list/${selectedCountry.value || selectedCountry}`, {
                headers: {
                    'Authorization': `Bearer ${usertoken}`
                }
            })
    ...
    useEffect(() => {
        if (selectedState) {
            axios.get(`https://epkgroup.in/crm/api/public/api/city_list/${selectedState.value || selectedState}`, {
                headers: {
                    'Authorization': `Bearer ${usertoken}`
                }
            })
    ...
    useEffect(() => {
        if (attachment) {
            setImagePreviewUrl(`https://epkgroup.in/crm/api/storage/app/${attachment}`);
    ...
    useEffect(() => {
        axios.get(`https://epkgroup.in/crm/api/public/api/resume_edit_list/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
    ...
    useEffect(() => {
        ...
        const fetchCities = async () => {
            try {
                const response = await axios.get('https://epkgroup.in/crm/api/public/api/all_city_list', {
                    headers: {
                        'Authorization': `Bearer ${usertoken}`
                    }
                });
