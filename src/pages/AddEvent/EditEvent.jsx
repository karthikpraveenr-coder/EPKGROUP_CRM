...
export default function EditEvent() {
    ...
    useEffect(() => {
        if (eventImage) {
            document.querySelector("#img").setAttribute("src", `https://epkgroup.in/crm/api/storage/app/${eventImage}`);
        }
    }, [eventImage]);
    ...
    useEffect(() => {
        axios.get(`https://epkgroup.in/crm/api/public/api/view_editevent/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
