...
function EditAttendanceType() {
    ...
    const handleSave = (e) => {
        ...
        axios.put(`https://epkgroup.in/crm/api/public/api/update_attendancetype`, requestData, {
            headers: {
    ...
    useEffect(() => {
        axios.get(`https://epkgroup.in/crm/api/public/api/editview_attendancetype/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
