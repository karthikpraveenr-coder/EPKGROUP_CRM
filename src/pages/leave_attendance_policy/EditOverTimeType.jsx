...
function EditOverTimeType() {
    ...
    const handleSave = (e) => {
        ...
        axios.put(`https://epkgroup.in/crm/api/public/api/update_ot_requesttype`, requestData, {
            headers: {
    ...
    useEffect(() => {
        axios.get(`https://epkgroup.in/crm/api/public/api/editview_ot_requesttype/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
