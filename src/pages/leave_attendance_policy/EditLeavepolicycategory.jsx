...
function EditLeavepolicycategory() {
    ...
    const handleSave = (e) => {
        ...
        axios.put(`https://epkgroup.in/crm/api/public/api/update_leavecategory`, requestData, {
            headers: {
    ...
    useEffect(() => {
        axios.get(`https://epkgroup.in/crm/api/public/api/editview_leavecategory/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
