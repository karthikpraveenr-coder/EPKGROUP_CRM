...
function EditAttendancePolicy() {
    ...
    const handleSubmit = (e) => {
        ...
        axios.put('https://epkgroup.in/crm/api/public/api/update_attendancepolicy', requestData, {
            headers: {
    ...
    useEffect(() => {
        axios.get(`https://epkgroup.in/crm/api/public/api/editview_attendancepolicy/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
