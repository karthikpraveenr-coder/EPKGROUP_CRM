...
function LeavePolicy() {
    ...
    useEffect(() => {
        ...
        axios.get('https://epkgroup.in/crm/api/public/api/leave_type_list', {
            headers: {
    ...
    useEffect(() => {
        const apiUrl = `https://epkgroup.in/crm/api/public/api/employee_dropdown_list/${formattedSelectedRole}`;
    ...
    const handleSave = (e) => {
        ...
        axios.put(`https://epkgroup.in/crm/api/public/api/update_leavepolicy`, requestData, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${usertoken}`
            }
    ...
    useEffect(() => {
        ...
        axios.get(`https://epkgroup.in/crm/api/public/api/editview_leavepolicy/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
                    ...
                    <Row>
                        <Col>
                            <Form.Group controlId="formStartDate">
                                ...
                                <Form.Control type="date" value={startDate} max={endDate || "9999-12-31"} onChange={(e) => setStartDate(e.target.value)} />
                        ...
                        <Col>
                            <Form.Group controlId="formEndDate">
                                ...
                                <Form.Control type="date" value={endDate} min={startDate || "0001-01-01"} max="9999-12-31" onChange={(e) => setEndDate(e.target.value)} />
