...
function OnlineTrialPackList() {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await fetch('https://epkgroup.in/crm/api/public/api/getonline_trialpacklist', {
                method: 'GET',
                headers: {
    ...
    const handleActivebtnClick = (row) => {
        ...
        axios.post('https://epkgroup.in/crm/api/public/api/trialpack_active', payload, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${usertoken}`,
            }
