...
const SalesEditLead = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://epkgroup.in/crm/api/public/api/editpresale_leadlist', formData, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
    ...
    //         try {
    //             const response = await axios.get('https://epkgroup.in/crm/api/public/api/getautogenerateLeadId', {
    //                 headers: {
    ...
    useEffect(() => {
        axios.get(`https://epkgroup.in/crm/api/public/api/viewedit_leadlist/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
                            ...
                            <Form.Group controlId="preferredLocation">
                                {consultDocument !== '-' && (
                                    <>
                                        ...
                                        <button style={{}} className="btn-view" onClick={() => { window.open(`https://epkgroup.in/crm/api/storage/app/${consultDocument}`, '_blank') }}>
