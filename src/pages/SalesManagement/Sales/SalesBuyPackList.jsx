...
function SalesBuyPackList() {
    ...
    const GoToEditPage = (id) => {
        navigate(`/admin/editsalesbuypackList/${id}`);
    };

    const GoToViewPage = (id) => {
        navigate(`/admin/salesbuypackview/${id}`);
    };
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await fetch('https://epkgroup.in/crm/api/public/api/getsales_buynowpacklist', {
                method: 'POST',
                headers: {
...
export default SalesBuyPackList