...
function SalesLeadList() {
    ...
    const GoToEditPage = (id) => {
        navigate(`/admin/viewsalesleadlist/${id}`);
    };
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await fetch('https://epkgroup.in/crm/api/public/api/sale_leadlist', {
