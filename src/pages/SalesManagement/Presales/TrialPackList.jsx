...
import './css/TrialPackListStyle.css'


function TrialPackList() {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await fetch('https://epkgroup.in/crm/api/public/api/gettrial_packlist', {
                method: 'POST',
                headers: {
