...
function EditPresalesBuyPackList() {
    const navigate = useNavigate();

    const GoToproformainvoicelist = () => {
        navigate(`/admin/presalesbuypacklist`);
    };
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`https://epkgroup.in/crm/api/public/api/getbuybowpackpresalesviewlist/${id}`, {
                    headers: {
    ...
    useEffect(() => {
        // Fetch Plan options
        axios.get('https://epkgroup.in/crm/api/public/api/webproduct_list')
            .then(response => {
        ...
        axios.get('https://epkgroup.in/crm/api/public/api/webmodule_list')
            .then(response => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://epkgroup.in/crm/api/public/api/getbuybowpackupdatestatuslist', payload, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
    ...
    // ------------------------------------------------------------------------------------------------------------
    useEffect(() => {
        axios.get('https://epkgroup.in/crm/api/public/api/office3i_country_list', {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
    ...
    useEffect(() => {
        if (selectedCountry) {
            axios.get(`https://epkgroup.in/crm/api/public/api/office3i_state_list/${selectedCountry.value || selectedCountry}`, {
                headers: {
                    'Authorization': `Bearer ${usertoken}`
                }
            })
    ...
    useEffect(() => {
        if (selectedState) {
            axios.get(`https://epkgroup.in/crm/api/public/api/office3i_city_list/${selectedState.value || selectedState}`, {
                headers: {
                    'Authorization': `Bearer ${usertoken}`
                }
            })
    ...
    useEffect(() => {
        ...
        axios.get(`https://epkgroup.in/crm/api/public/api/webproductmodule_list/${selectedPlan}`)
            .then(response => {
    ...
    useEffect(() => {
        axios.get('https://epkgroup.in/crm/api/public/api/payment_method_status', {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
    ...
    useEffect(() => {
        axios.get('https://epkgroup.in/crm/api/public/api/payment_type_status', {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
...
export default EditPresalesBuyPackList;
