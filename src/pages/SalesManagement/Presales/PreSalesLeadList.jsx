...
function PreSalesLeadList() {
    ...
    const GoToEditPage = (id) => {
        navigate(`/admin/viewpresalesleadlist/${id}`);
    };
...
export default PreSalesLeadList