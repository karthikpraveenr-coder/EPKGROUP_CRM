                        ...
                        <Row>
                            ...
                            <Col style={key__value}><strong>Attached Link</strong>
                                {resumeData.consultfee_document !== '-' ? (
                                    <button style={{ width: '75px', height: '35px' }} className="btn-view" onClick={() => { window.open(`https://epkgroup.in/crm/api/storage/app/${resumeData.consultfee_document}`, '_blank') }}>
...
export default ViewPreSalesLeadList;
