...
function ViewJobcard() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`https://epkgroup.in/crm/api/public/api/edit_jobopening_list/${id}`, {
                    headers: {
    ...
    const handleDelete = async () => {
        try {
            ...
            if (reason) {
                const response = await axios.post('https://epkgroup.in/crm/api/public/api/delete_job_opening', {
                    id: id,
