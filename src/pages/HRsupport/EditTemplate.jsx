...
function EditTemplate() {
    ...
    // useEffect(() => {
    //     if (file) {
    //         document.querySelector("#img").setAttribute("src", `https://epkgroup.in/crm/api/storage/app/${file}`);
    //     }
    // }, [file]);
    ...
    //     axios.post(`https://epkgroup.in/crm/api/public/api/hr_template_update`, formData, {
    //         headers: {
    ...
    useEffect(() => {
        axios.get(`https://epkgroup.in/crm/api/public/api/hr_edit_templatelist/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
                            ...
                            <Col sm={6} md={6} lg={6} xl={6}>
                                <Form.Group controlId="formFile">
                                    ...
                                    {file && file.endsWith('.pdf') ? (
                                        <a id="fileLink" href={`https://epkgroup.in/crm/api/storage/app/${file}`} target="_blank" rel="noopener noreferrer">
                                            View Current PDF
                                        </a>
                                    ) : (
                                        <img id="img" src={file ? `https://epkgroup.in/crm/api/storage/app/${file}` : ''} alt="file" style={{ height: '150px' }} />
                                    )}
