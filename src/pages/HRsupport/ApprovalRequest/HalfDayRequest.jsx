...
function HalfDayRequest() { 
    ...
    const handleStatusButtonClick = (row, status) => {
        ...
        fetch('https://epkgroup.in/crm/api/public/api/approval_halfday_request', {
            method: 'POST',
            body: formData,
            headers: {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await fetch('https://epkgroup.in/crm/api/public/api/hr_halfday_approvallist', {
                method: 'POST',
                headers: {
                                    ...
                                    filteredleaveData.map((row, index) => {
                                        ...
                                        return (
                                            <tr key={row.id}>
                                                ...
                                                <td>{row.proof !== null ?
                                                    <button className="btn-view" onClick={() => { window.open(`https://epkgroup.in/crm/api/storage/app/${row.proof}`, '_blank') }}>
