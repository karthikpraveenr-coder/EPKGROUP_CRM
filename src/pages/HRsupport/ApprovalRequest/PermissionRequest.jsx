...
function PermissionRequest() { 
    ...
    const handleStatusButtonClick = (row, status) => {
        ...
        fetch('https://epkgroup.in/crm/api/public/api/approval_permission_request', {
            method: 'POST',
            body: formData,
            headers: {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await fetch('https://epkgroup.in/crm/api/public/api/hr_permission_approvallist', {
