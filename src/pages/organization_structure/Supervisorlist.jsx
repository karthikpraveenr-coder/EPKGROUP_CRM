...
function Supervisorlist() {
    ...
    useEffect(() => {
        axios.get('https://epkgroup.in/crm/api/public/api/supervisor_userrole', {
            headers: {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://epkgroup.in/crm/api/public/api/addsupervisor', requestData, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${usertoken}`
            }
    ...
    const fetchData = async () => {
        try {
            const response = await fetch('https://epkgroup.in/crm/api/public/api/view_supervisor', {
                headers: {
                    'Authorization': `Bearer ${usertoken}`
                }
            });
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://epkgroup.in/crm/api/public/api/delete_supervisor', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
