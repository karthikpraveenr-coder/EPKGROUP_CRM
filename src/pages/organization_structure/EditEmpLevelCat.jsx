...
function EditEmpLevelCat() {
    ...
    const handleSave = (e) => {
        ...
        axios.put(`https://epkgroup.in/crm/api/public/api/update_emplevelcategory`, requestData, {
            headers: {
    ...
    useEffect(() => {
        axios.get(`https://epkgroup.in/crm/api/public/api/editview_emplevelcategory/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
