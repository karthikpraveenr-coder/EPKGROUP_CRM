...
const EditAssignedList = () => {
    ...
    useEffect(() => {
        const fetchAssetId = async () => {
            try {
                const response = await axios.get(`https://epkgroup.in/crm/api/public/api/editview_raiselist/${id}`, {
                    headers: {
    ...
    const handleSave = (e) => {
        ...
        axios.put('https://epkgroup.in/crm/api/public/api/update_raiseticket', formData, {
            headers: {
                'Content-Type': 'application/json',
                    ...
                    <Row className='mb-3'>
                        ...
                        <Col md={6}>
                            <Form.Group controlId="formDepartment">
                                ...
                                <Form.Control as="select" value={assignDepartment} onChange={(e) => setAssignDepartment(e.target.value)} disabled>
                                    <option value="">Select Department</option>
                    ...
                    <Row className='mb-3'>
                        <Col md={6}>
                            <Form.Group controlId="formEmployeeName">
                                ...
                                <Form.Control as="select" value={assignEmployee} onChange={(e) => setAssignEmployee(e.target.value)} disabled>
                                    <option value="">Select Employee</option>
