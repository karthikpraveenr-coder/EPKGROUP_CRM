...
function EditAssetsType() {
    ...
    useEffect(() => {
        const fetchAssetId = async () => {
            try {
                const response = await axios.get(`https://epkgroup.in/crm/api/public/api/edit_asset_typelist/${id}`, {
                    headers: {
    ...
    const handleSave = (e) => {
        ...
        axios.put('https://epkgroup.in/crm/api/public/api/update_asset_type', requestData, {
            headers: {
                'Content-Type': 'application/json',
