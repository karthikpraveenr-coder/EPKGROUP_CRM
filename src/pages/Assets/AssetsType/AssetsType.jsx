...
function AssetsType() {
    ...
    useEffect(() => {
        const fetchAssetId = async () => {
            try {
                const response = await axios.get('https://epkgroup.in/crm/api/public/api/asset_id', {
                    headers: {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://epkgroup.in/crm/api/public/api/add_asset_type', requestData, {
            headers: {
                'Content-Type': 'application/json',
    ...
    const fetchData = async () => {
        try {
            const response = await fetch('https://epkgroup.in/crm/api/public/api/asset_type_list', {
                headers: {
                    'Authorization': `Bearer ${usertoken}`
                }
            });
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://epkgroup.in/crm/api/public/api/delete_asset_type', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${usertoken}` // Assuming usertoken is defined somewhere
