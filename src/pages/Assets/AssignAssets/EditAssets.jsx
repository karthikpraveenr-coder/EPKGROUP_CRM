...
const EditAssets = () => {
    ...
    useEffect(() => {
        const fetchAssetId = async () => {
            try {
                const response = await axios.get(`https://epkgroup.in/crm/api/public/api/edit_assign_assetlist/${id}`, {
                    headers: {
    ...
    const handleSave = async (e) => {
        ...
        try {
            const response = await fetch('https://epkgroup.in/crm/api/public/api/update_assign_asset', {
                method: 'PUT',
    ...
    useEffect(() => {
        const fetchAssetTypes = async () => {
            try {
                const response = await axios.get('https://epkgroup.in/crm/api/public/api/asset_name', {
                    headers: {
                        'Authorization': `Bearer ${usertoken}`
                    }
                });
