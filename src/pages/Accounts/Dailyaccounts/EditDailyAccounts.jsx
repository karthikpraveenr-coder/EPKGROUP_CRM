...
function EditDailyAccounts() {
    ...
    const handleSave = (e) => {
        ...
        axios.post(`https://epkgroup.in/crm/api/public/api/updatedailyaccounts`, requestData, {
            headers: {
    ...
    useEffect(() => {
        axios.get(`https://epkgroup.in/crm/api/public/api/editview_dailyaccounts/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
