...
function SalesInvoiceList() {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await fetch('https://epkgroup.in/crm/api/public/api/view_saleinvoice', {
                method: 'GET',
                headers: {
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://epkgroup.in/crm/api/public/api/delete_saleinvoice', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
