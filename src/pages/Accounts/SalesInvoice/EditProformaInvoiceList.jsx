...
function EditProformaInvoiceList() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`https://epkgroup.in/crm/api/public/api/getbuybowpackproformainvoiceviewlist/${id}`, {
                    headers: {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://epkgroup.in/crm/api/public/api/getbuybowpackproformainvoiceeditlist', payload, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
...
export default EditProformaInvoiceList;
