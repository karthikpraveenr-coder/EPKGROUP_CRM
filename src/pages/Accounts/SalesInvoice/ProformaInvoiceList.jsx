...
function ProformaInvoiceList() {
    ...
    const GoToEditPage = (id) => {
        navigate(`/admin/editproformainvoicelist/${id}`);
    };

    const GoToViewPage = (id) => {
        navigate(`/admin/proformainvoiceview/${id}`);
    };
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await fetch('https://epkgroup.in/crm/api/public/api/getbuybowpackproformainvoicelist', {
                method: 'GET',
                headers: {
    ...
    const handleExportCSV = () => {
        ...
        const csvReport = {
            data: csvData,
            headers: headers,
            filename: 'ProformaInvoicelist.csv',
        };
    ...
    const handleExportPDF = () => {
        ...
        doc.save('ProformaInvoicelist.pdf');
        ...
        <>
            ...
            {loading ? (
                ...
                <Container fluid className='shift__container'>
                    <h3 className='mb-5' style={{ fontWeight: 'bold', color: '#00275c' }}>Proforma Invoice List</h3>
