...
function AddGoodsServices() {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://epkgroup.in/crm/api/public/api/addgood_service', requestData, {
            headers: {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch('https://epkgroup.in/crm/api/public/api/view_goodservice', {
                headers: {
                    'Authorization': `Bearer ${usertoken}`
                }
            });
