...
function PurchaseInvoiceList() {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await fetch('https://epkgroup.in/crm/api/public/api/view_purchaseinvoice', {
                method: 'GET',
                headers: {
    ...
    useEffect(() => {
        fetch('https://epkgroup.in/crm/api/public/api/view_saleinvoice', {
            headers: {
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://epkgroup.in/crm/api/public/api/delete_purchaseinvoice', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
