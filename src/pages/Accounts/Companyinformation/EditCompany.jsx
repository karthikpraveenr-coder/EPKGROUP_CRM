...
const EditCompany = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.put(`https://epkgroup.in/crm/api/public/api/update_company_information`, requestData, {
            headers: {
    ...
    useEffect(() => {
        axios.get(`https://epkgroup.in/crm/api/public/api/editview_company_information/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
