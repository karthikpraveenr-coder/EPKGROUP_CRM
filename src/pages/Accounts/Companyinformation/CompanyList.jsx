...
function CompanyList() {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await fetch('https://epkgroup.in/crm/api/public/api/view_company_information', {
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://epkgroup.in/crm/api/public/api/delete_company_information', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
