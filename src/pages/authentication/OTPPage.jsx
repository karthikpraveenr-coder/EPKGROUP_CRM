...
const OTPPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://epkgroup.in/crm/api/public/api/forgot_otp_verifiy', {
                email: userEmail,
                otp: fullOtp
            });
    ...
    const resendOtp = async (e) => {
        ...
        try {
            const response = await fetch('https://epkgroup.in/crm/api/public/api/forgot_password', {
                method: 'POST',
                headers: {
