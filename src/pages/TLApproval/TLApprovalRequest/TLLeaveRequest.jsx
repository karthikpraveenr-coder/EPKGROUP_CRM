...
function TLLeaveRequest() {
  ...
  const handleStatusButtonClick = (row, status) => {
    ...
    fetch('https://epkgroup.in/crm/api/public/api/tl_approval_leave_request', {
      method: 'POST',
      body: formData,
      headers: {
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await fetch('https://epkgroup.in/crm/api/public/api/tl_leaverequest_list', {
