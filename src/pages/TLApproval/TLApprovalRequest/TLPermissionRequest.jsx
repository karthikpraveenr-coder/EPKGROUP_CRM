...
function TLPermissionRequest() {
    ...
    const handleStatusButtonClick = (row, status) => {
        ...
        fetch('https://epkgroup.in/crm/api/public/api/tl_approval_permission_request', {
            method: 'POST',
            body: formData,
            headers: {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await fetch('https://epkgroup.in/crm/api/public/api/tl_permissionrequest_list', {
    ...
    const handleExportCSV = () => {
        ...
        const csvReport = {
            data: csvData,
            headers: headers,
            filename: 'TLPermissionRequest.csv',
        };
    ...
    const handleExportPDF = () => {
        ...
        doc.save('TLPermissionRequest.pdf');
