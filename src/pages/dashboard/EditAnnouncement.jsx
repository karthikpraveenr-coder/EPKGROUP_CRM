...
function EditAnnouncement() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('https://epkgroup.in/crm/api/public/api/view_announcement', {
                headers: {
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://epkgroup.in/crm/api/public/api/delete_announcement', {
                    method: 'POST',
                    headers: {
    ...
    const handleedit = async (id) => {
        ...
        axios.get(`https://epkgroup.in/crm/api/public/api/editview_announcement/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
    ...
    const handleSave = (e) => {
        ...
        axios.put(`https://epkgroup.in/crm/api/public/api/update_announcement`, requestData, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${usertoken}`
            }
