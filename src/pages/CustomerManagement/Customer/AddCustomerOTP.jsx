...
const AddCustomerOTP = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {                                                  
            const response = await axios.post('https://epkgroup.in/crm/api/public/api/office3i_singup_otpverification', {
                email_id: email,
    ...
    const resendOtp = async (e) => {
        ...
        if (!validateEmail(email)) {
            ...
            try {
                const response = await fetch('https://epkgroup.in/crm/api/public/api/office3i_singup_resentotp', {
                    method: 'POST',
                    headers: {
