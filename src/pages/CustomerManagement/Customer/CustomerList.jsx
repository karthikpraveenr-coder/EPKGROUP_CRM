...
function CustomerList() {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await fetch('https://epkgroup.in/crm/api/public/api/customer_list', {
                method: 'GET',
                headers: {
    ...
    const handleExportCSV = () => {
        const csvData = tableData.map(({ name, email, company_name, mobile_number }, index) => ({
            '#': index + 1,
            name,
            email,
            company_name,
    ...
    const handleExportPDF = () => {
        ...
        const data = tableData.map(({ name, email, company_name, mobile_number }, index) => [
            index + 1,
            name,
            email,
            company_name,
        ...
        doc.autoTable({
            head: [['S.No', 'Name', 'Email', 'Company Name', 'Mobile Number']],
            body: data,
        ...
        <>
            ...
            {loading ? (
                ...
                <Container fluid className='shift__container'>
                    <h3 className='mb-5' style={{ fontWeight: 'bold', color: '#00275c' }}>Customer List</h3>
